...
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/tax-rates${pathSegment}${queryString ? `?${queryString}` : ""}`
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/tax-rates${pathSegment}`
...
export async function DELETE(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/tax-rates${pathSegment}${reason ? `?reason=${encodeURIComponent(reason)}` : ""}`
