...
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/brands${pathSegment}${queryString ? `?${queryString}` : ""}`
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/brands${pathSegment}`
...
export async function DELETE(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/brands${pathSegment}${reason ? `?reason=${encodeURIComponent(reason)}` : ""}`
