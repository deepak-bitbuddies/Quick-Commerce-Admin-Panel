...
export async function GET(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/products${pathSegment}${queryString ? `?${queryString}` : ""}`
...
export async function POST(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/products${pathSegment}`
...
export async function DELETE(request: NextRequest, { params }: RouteContext) {
  ...
  const backendPath = `/api/v1/admin/products${pathSegment}${reason ? `?reason=${encodeURIComponent(reason)}` : ""}`
